...
<body>
	...
	<div id="body_wrapper">
		...
		<div id="about-wrapper">
			...
			<p><b>Andrew Pistole:</b> A Senior majoring in Computer Science at the University of Missouri. Andrew was in charge of the login to the website, finding and adding various pictures as well as assisting in any other division and error checking.</p>
			...
			<p><b>Yihua Shi:</b> A Senior majoring in Computer Science at the University of Missouri. Yihua generated the ERD when we're designing our database. Her responsibility was to design the page that displayed database calls for spices and categories, as well as generated the layout for the site. She also coded database calls for her own page and helped fixing problems.</p>
		</div>

...
INSERT INTO Spices VALUES('Whole Caraway Seeds','Caraway seeds are on the shopping list for most of our German customers.  This traditional taste is used in sauerkraut, coleslaw, goulash, stews, cheese, rye bread, seed cake, pork roast, and fish & shrimp boil.',6.99,16,52,'sauerkraut, coleslaw, goulash, stews, cheese, rye bread, pork, fish, shrimp', NULL);
INSERT INTO Spices VALUES('Whole Celery Seed','Celery seeds most popular usage is in coleslaw and potato salads.  Celery seed is a small, somewhat bitter, seed often found as an ingredient in cold vegetable salads, sauerkraut and pickling.',6.29,8,53,'vegetable salads, sauerkraut, spice rubs, fish');
...
INSERT INTO Spices VALUES('Crushed Brown Mustard Seed','Crushed brown mustard seeds are called Bavarian-style mustard. These brown mustard seeds are nice for making a sharp tasting coarse mustard paste, which goes well with brats and kraut.',3.99,8,58,'bratwurst, sauerkraut, mustard','European, German, Indian');
...
INSERT INTO Spices VALUES('Hungarian Sweet Paprika','Sweet Hungarian paprika is perfect for your favorite goulash or deviled eggs. Fresh paprika has a full, sweet pepper flavor without the heat. Its not just a pretty garnishing color!',6.69,8,60,'Deviled Eggs, potatoes, chicken, fish, goulash','Eastern European, Greek and Turkish, Hungarian');
